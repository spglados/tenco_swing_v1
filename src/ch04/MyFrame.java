...
public class MyFrame extends JFrame {
	...
	private void initData() {
		...
		backgroundMap.setSize(640, 360);
		backgroundMap.setLocation(0, 0);

		player = new JLabel(new ImageIcon("images/thatchericon.png"));
		player.setSize(200, 200);
		player.setLocation(300,70);
	}

	private void setInitLayout() {
		// 좌표값으로 셋팅 하기 위해서는 배치관리를 null 값으로 만들어 주어야 한다.
		setLayout(null);
		add(backgroundMap);
